class Footbal:
    national_teams = ""
teams = Footbal
teams.national_teams = "Argentina"
print(teams.national_teams.upper())

players = ""
player = Footbal
player.players = "Messi"
print(player.players.lower())
...
michellene = Tyres
michellene.summer_tyres = "L 85"
michellene.summer_tyres = "V 67"
michellene.summer_tyres = "L 200"
michellene.winter_tyres = "Mood and Dirt"
michellene.winter_tyres = "Montains"

print("The best winter tyres are {} and the best summer tyres are {} ".format(michellene.summer_tyres,michellene.winter_tyres))
